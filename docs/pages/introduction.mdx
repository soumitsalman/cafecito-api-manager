...
| **[Espresso](/howtos/espresso-howto)** Market Intelligence | <Badge className="badge-live">Live</Badge> | Microactions, Events intelligence, Derived Signals, Semantic Search, Tag Filtering, Event Relationship, MCP-friendly text responses. |
