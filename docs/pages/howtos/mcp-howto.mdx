...
# navigation_icon_dark: /mcp-dark.svg
...
:::info{title="Same API Key"}
Your existing API keys work for MCP calls too. They share the same rate limit and quota meter for that product.
:::
